...
Full protocol (secret gist, owner access only): internal gist reference.
Repository is public: every file, commit message and PR description is world-readable.
